...
namespace SkillsTest.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> StudentIndex()
        {
            ...
            {
                var result = await _studentRepository.GetListWithUserAndEnrollmentsAsync();
                student = result.FirstOrDefault(f => f.UserID == HttpContext.User.Identity.GetUserId());
                ViewBag.Courses = await _studentRepository.GetAsync(student.UserID);
            }
            return View(student);
        }
